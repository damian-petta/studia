...
HRESULT InitDevice()
{
    ...
    {
        //prawa kreska
       { XMFLOAT3(0,0,0),XMFLOAT3(3,3,3)},     //108 0,0
       { XMFLOAT3(-1,0,0),XMFLOAT3(3,3,3) },   //109 1,0
       { XMFLOAT3(0,5,0),XMFLOAT3(3,3,3) },    //110 0,1
       { XMFLOAT3(-1,5,0),XMFLOAT3(3,3,3) },   //111 1,1

       //skosy
       { XMFLOAT3(-1,4,0),XMFLOAT3(3,3,3) },   //112 prawe zaczepienie
       { XMFLOAT3(-2.5f,4,0),XMFLOAT3(3,3,3) },//113 srodek góra
       { XMFLOAT3(-4,4,0),XMFLOAT3(3,3,3) },   //114 lewe zaczepienie
       { XMFLOAT3(-2.5f,3,0),XMFLOAT3(3,3,3) },//115 srodek dol

       //lewa kreska
       { XMFLOAT3(-4,0,0),XMFLOAT3(3,3,3) },   //116 0,0
       { XMFLOAT3(-5,0,0),XMFLOAT3(3,3,3) },   //117 1,0
       { XMFLOAT3(-4,5,0),XMFLOAT3(3,3,3) },   //118 0,1
       { XMFLOAT3(-5,5,0),XMFLOAT3(3,3,3) },   //119 1,1


       //----odbicie symetryczne
       { XMFLOAT3(0,0,-2),XMFLOAT3(3,3,3) },   //120 0,0
       { XMFLOAT3(-1,0,-2),XMFLOAT3(3,3,3) },  //121 1,0
       { XMFLOAT3(0,5,-2),XMFLOAT3(3,3,3) },   //122 0,1
       { XMFLOAT3(-1,5,-2),XMFLOAT3(3,3,3) },  //123 1,1

       { XMFLOAT3(-1,4,-2),XMFLOAT3(3,3,3) },  //124 prawe zaczepienie
       { XMFLOAT3(-2.5f,4,-2),XMFLOAT3(3,3,3)},//125 srodek gora
       { XMFLOAT3(-4,4,-2),XMFLOAT3(3,3,3) },  //126 lewe zaczepienie
       { XMFLOAT3(-2.5f,3,-2),XMFLOAT3(3,3,3)},//127 srodek dol


       { XMFLOAT3(-4,0,-2),XMFLOAT3(3,3,3) },  //128 0,0
       { XMFLOAT3(-5,0,-2),XMFLOAT3(3,3,3) },  //129 1,0
       { XMFLOAT3(-4,5,-2),XMFLOAT3(3,3,3) },  //130 0,1
       { XMFLOAT3(-5,5,-2),XMFLOAT3(3,3,3) },  //131 1,1
